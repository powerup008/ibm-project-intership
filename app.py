...
# ==========================================
# 2. LOGIN SYSTEM LOGIC (ACCEPTS ANY INPUT)
# ==========================================
...
html, body, h1, h2, h3, h4, h5, h6, p, label, .stMarkdown {
    ...
    if not uploaded_file:
        ...
        with st.spinner("Generating AI caption and rendering image..."):
            try:
                ...
                # Using the user's selected tone accurately!
                ...
                try:
                    ...
                    st.warning(f"Font file '{selected_font_file}' not found. Falling back to default.")
